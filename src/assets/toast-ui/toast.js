...
const toastMessage = (message, type, options = {}) => {
    ...
    const posiblePositions = ['top-left', 'top-center', 'top-right', 'bottom-left', 'bottom-center', 'bottom-right']
    defaultOptions.position = posiblePositions.includes(toastOptions.position) ? toastOptions.position : 'top-right'

    const containerExists = document.querySelector(`#toastContainer.${toastOptions.position}`)
    ...
    const toastContainer = document.querySelector(`#toastContainer.${toastOptions.position}`)
    ...
    toastOptions.newestOnTop ? toastContainer.prepend(toast) : toastContainer.appendChild(toast)
