...
import { UsuarioContext, BackscreenContext, useLoader, useModal } from '../../context/index.jsx';
import { jsonRoute } from "../../utils/json.js";
import styles from './styles.module.css';
import headerLogo from '/img/home_caaes/logo.svg';
import { useAtom } from 'jotai';
import { tipoUsuarioAtom} from '../../context/jotai.jsx';
import ModalInfo from "./components/modalInfo";

export default function HeaderCaaes() {
        ...
        <div className={styles.headerContent}>
          ...
          <>
            ...
            <menu className={styles.headerMenu}>
              <li className={`${styles.headerMenuItem} ${styles.headerLoginButton}`} tabIndex="0" onClick={() => openModal("modalInfo")}>
