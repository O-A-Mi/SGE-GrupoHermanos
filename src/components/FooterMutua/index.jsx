...
import LogoMutua from '/img/home_mutua/logo.png';
...
const ContactInfo = () => (
  <section className={`${styles.footerSection} ${styles.ContactInfo}`}>
    ...
    <p className={styles.schedule}>
      <strong>Central de atendimento:</strong> 0800 000 3507
    </p>
    <p className={styles.contactDetails}>
    <strong>E-mail:</strong> contato@doutorhoje.com.br
    </p>
    </div>
  </section>
);
          ...
          <div className={styles.footerContent}>
              <div className={styles.footerDivider}>
                  <div className={`${styles.footerLogoField} ${styles.FooterLogo}`}>
                    ...
                    <img className={styles.logos} src={LogoMutua} alt="logo_DrOnline" />
                  </div>
