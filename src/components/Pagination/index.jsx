...
function Pagination({ totalCards, cardsPerPage, setCurrentPage, currentPage, setCardsPerPage, cardsPerPageOptions, indexOfFirstCard, indexOfLastCard, selectedRows, showNumberOfRows = true, showPageSelector = true }) {
  ...
  return (
    <nav className={styles.pagination} ref={paginationRef}>
      {(showNumberOfRows || showPageSelector || selectedRows > 0) && (
        <div className={styles.topRowControls}>
          {showNumberOfRows && totalCards > 0 && (
          ...
          {(showPageSelector || totalPages > 1) && (
            <div className={styles.recordsPerPageSelector}>
              ...
              <select
                ...
                value={cardsPerPage?cardsPerPage:defaultOptions.cardsPerPage}
                onChange={handleCardsPerPageChange}
              >
                {(cardsPerPageOptions?cardsPerPageOptions:defaultOptions.cardsPerPageOptions).map((option) => (
